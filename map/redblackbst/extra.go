...
func (r RedBlack) dotGraph(h *mapnode, out io.Writer, name string) (n int, err error) {
...
func (r RedBlack) dotvisit(x *mapnode, nodes io.Writer, edges *bytes.Buffer, isLeft bool) {
